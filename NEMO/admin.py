...
from NEMO.actions import lock_selected_interlocks, synchronize_with_tool_usage, unlock_selected_interlocks, \
	duplicate_tool_configuration, enable_visible_tools, enable_operational_tools, disable_visible_tools, disable_operational_tools 
...
class ToolAdmin(admin.ModelAdmin):
	...
	actions = [duplicate_tool_configuration, enable_visible_tools, enable_operational_tools, disable_visible_tools, disable_operational_tools ]
	form = ToolAdminForm
	fieldsets = (
